...
class _DevelopmentalMilestonesFourMonthState
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          centerTitle: true,
          title: Text(
            l10n.ms_four_month_developmental_milestones,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ⭐ SOCIAL
                    _buildSection(
                      title: l10n.ms_four_month_social_emotional,
                      index: 0,
                      milestones: [
                        _MilestoneCard(
                          title: l10n
                              .ms_four_month_smiles_on_his_own_to_get_your_attention,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_four_month_chuckles_not_a_full_laugh_when_you_try_to_make_her_laugh,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_four_month_looks_at_you_moves_or_makes_sounds_to_get_your_attention,
                          videoUrl:
                    ...
                    // ⭐ SPEECH
                    _buildSection(
                      title: l10n.ms_four_month_speech_language,
                      index: 1,
                      milestones: [
                        _MilestoneCard(
                          title: l10n
                              .ms_four_month_makes_sounds_like_ooo_aahh_cooing,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_four_month_makes_sounds_back_when_you_talk_to_her,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_four_month_turns_head_towards_sound_of_your_voice,
                    ...
                    // ⭐ COGNITIVE
                    _buildSection(
                      title: l10n.ms_four_month_cognitive_development,
                      index: 2,
                      milestones: [
                        _MilestoneCard(
                          title: l10n
                              .ms_four_month_if_hungry_opens_mouth_when_she_sees_breast_or_bottle,
                    ...
                    // ⭐ MOVEMENT
                    _buildSection(
                      title: l10n.ms_four_month_movement_physical_development,
                      index: 3,
                      milestones: [
                        _MilestoneCard(
                          title: l10n
                              .ms_four_month_holds_head_steady_without_support,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_four_month_holds_a_toy_when_you_put_it_in_her_hand,
                        ...
                        _MilestoneCard(
                          title: l10n.ms_four_month_uses_arm_to_swing_at_toys,
                        ...
                        _MilestoneCard(
                          title: l10n.ms_four_month_brings_hands_to_mouth,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_four_month_pushes_up_onto_elbows_forearms_when_on_tummy,
  ...
  Widget _buildProgressCard(double progress) => Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              l10n.ms_four_month_overall_progress,
              style: const TextStyle(
                  fontFamily: 'Inter',
            ...
            Text(
              l10n.ms_four_month_only_check_milestones_you_re_confident_your_child_has_achiev,
              style: const TextStyle(
                fontFamily: 'Inter',
            ...
            Text(
              l10n.ms_four_month_completedcount_of_totalmilestones_milestones_complete(
