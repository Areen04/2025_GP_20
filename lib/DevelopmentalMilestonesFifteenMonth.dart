...
class _DevelopmentalMilestonesFifteenMonthState
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          elevation: 0,
          surfaceTintColor:
              Colors.transparent, // ✅ يمنع اللون الوردي عند السكرول
          scrolledUnderElevation: 0, // ✅ يمنع الشادو الملون
          centerTitle: true,
          title: Text(
            l10n.ms_fifteen_month_developmental_milestones,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // SOCIAL
                    _buildSection(
                      title: l10n.ms_fifteen_month_social_emotional,
                      index: 0,
                      milestones: [
                        _MilestoneCard(
                          title: l10n
                              .ms_fifteen_month_copies_other_children_while_playing_like_taking_toys_out_of_,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_fifteen_month_shows_you_an_object_she_likes,
                        ...
                        _MilestoneCard(
                          title: l10n.ms_fifteen_month_claps_when_excited,
                          videoUrl:
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_fifteen_month_hugs_stuffed_doll_or_other_toy,
                        ...
                        _MilestoneCard(
                          title: l10n.ms_fifteen_month_shows_affection,
                    ...
                    // LANGUAGE
                    _buildSection(
                      title: l10n.ms_fifteen_month_language_communication,
                      index: 1,
                      milestones: [
                        _MilestoneCard(
                          title: l10n
                              .ms_fifteen_month_tries_to_say_one_or_two_words_besides_mama_or_dada,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_fifteen_month_looks_at_familiar_objects_when_named,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_fifteen_month_follows_directions_with_both_a_gesture_and_words,
                          videoUrl:
                    ...
                    // COGNITIVE
                    _buildSection(
                      title: l10n.ms_fifteen_month_cognitive_development,
                      index: 2,
                      milestones: [
                        _MilestoneCard(
                          title: l10n
                              .ms_fifteen_month_uses_things_the_right_way_phone_cup,
                          imageUrl:
                        ...
                        _MilestoneCard(
                          title: l10n.ms_fifteen_month_stacks_two_objects,
                    ...
                    _buildSection(
                      title:
                          l10n.ms_fifteen_month_movement_physical_development,
                      index: 3,
                      milestones: [
                        _MilestoneCard(
                          title: l10n
                              .ms_fifteen_month_takes_a_few_steps_on_her_own,
  ...
  Widget _buildProgressCard(double progress) => Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              l10n.ms_fifteen_month_overall_progress,
              style: const TextStyle(
                fontFamily: 'Inter',
            ...
            Text(
              l10n.ms_fifteen_month_only_check_milestones_you_re_confident_your_child_has_achiev,
              style: const TextStyle(
                fontFamily: 'Inter',
            ...
            Text(
              l10n.ms_fifteen_month_completedcount_of_totalmilestones_milestones_complete(
