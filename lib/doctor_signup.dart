                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        enabledBorder: _border(_getColor(
                            _isNameValid, _nameController, _nameFocus)),
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: _border(Colors.grey),
                        enabledBorder: _border(_getColor(
                            _isEmailValid, _emailController, _emailFocus)),
                        focusedBorder: _border(_getColor(
                            _isEmailValid, _emailController, _emailFocus)),
                      ),
                    ),
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: _border(Colors.grey),
                        enabledBorder: _border(_getColor(_isPasswordValid,
                            _passwordController, _passwordFocus)),
                        focusedBorder: _border(_getColor(_isPasswordValid,
                            _passwordController, _passwordFocus)),
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: _border(Colors.grey),
                        enabledBorder: _border(_getColor(_passwordsMatch,
                            _confirmPasswordController, _confirmPasswordFocus)),
                        focusedBorder: _border(_getColor(_passwordsMatch,
                            _confirmPasswordController, _confirmPasswordFocus)),
                        suffixIcon: IconButton(
                          icon: Icon(
                    ...
                    Focus(
                      ...
                      child: DropdownMenu<String>(
                        ...
                        menuStyle: const MenuStyle(
                          ...
                          maximumSize:
                              WidgetStatePropertyAll(Size.fromHeight(120)),
                        ...
                        dropdownMenuEntries: [
                          DropdownMenuEntry(
                              value: "National ID", label: l10n.nationalId),
                          DropdownMenuEntry(value: "Iqama", label: l10n.iqama),
                          DropdownMenuEntry(
                              value: "Passport", label: l10n.passport),
                          DropdownMenuEntry(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: _border(Colors.grey),
                        enabledBorder: _border(_getColor(_isDocValid,
                            _docNumberController, _docNumberFocus)),
                        focusedBorder: _border(_getColor(_isDocValid,
                            _docNumberController, _docNumberFocus)),
                      ),
                    ),
                  ],
