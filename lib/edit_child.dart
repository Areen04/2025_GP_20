...
class _EditChildState extends State<EditChild> {
  ...
  // ✅ Same dropdown color logic as your AddChild style
  Color _dropdownColor({
    required String? value,
    required bool touched,
    required FocusNode focusNode,
  }) {
    // Selected → grey (like your current style)
    if (value != null) return Colors.grey;

    // Focused → purple
    if (focusNode.hasFocus) return const Color(0xFF9D5C7D);

    // Touched but no selection → grey
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    if (picked != null) {
      ...
      setState(() {
        ...
        _hasChanges = true; // image changed => enable save
      });
    }
  }
  ...
  Future<void> _saveChanges() async {
    try {
      ...
      if (_selectedGender != null && _selectedGender != _originalGender) {
      ...
      if (_image != null) {
        final ref = FirebaseStorage.instance.ref().child(
            'children_images/${DateTime.now().millisecondsSinceEpoch}.jpg');
                      ...
                      children: [
                        ...
                        Focus(
                          ...
                          child: DropdownMenu<String>(
                            ...
                            dropdownMenuEntries: [
                              DropdownMenuEntry(
                                  value: "Male", label: l10n.maleLabel),
                              DropdownMenuEntry(
                                  value: "Female", label: l10n.femaleLabel),
                            ],
                          ),
                        ),
                      ],
