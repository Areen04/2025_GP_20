// 🔥 ———————————————————————————————————————————————
// Developmental Milestones 9 Month (UPDATED TO MATCH 3y / 4m STYLE)
// 🔥 ———————————————————————————————————————————————
...
class _DevelopmentalMilestonesNineMonthState
  ...
  // Registry of all milestone cards to reset videos
    ...
    required List<Widget> milestones,
      ...
      Container(
        ...
        decoration: BoxDecoration(
          ...
          // ✔️ border like other updated pages
        ...
        child: Theme(
          ...
          child: ExpansionTile(
            ...
            trailing: AnimatedRotation(
              turns: expandedIndex == index ? 0.5 : 0, // down / up
...
// #####################################################################
//                 M I L E S T O N E   C A R D  (Unified style)
// #####################################################################
  ...
  void initState() {
    ...
    if (widget.videoUrl != null) {
      ...
      _controller!.initialize().then((_) async {
        // Force video engine to render a frame
