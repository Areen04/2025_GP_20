...
Widget _buildRequiredLabel(String text) {
 ...
 const SizedBox(height: 30),
                ...
                Column(
                  ...
                  children: [
                    _buildRequiredLabel(l10n.fullNameLabel),
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildRequiredLabel(l10n.emailLabel),
                    const SizedBox(height: 6),
...
// Password
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildRequiredLabel(l10n.passwordLabel),
                    const SizedBox(height: 6),
...
// Confirm Password
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildRequiredLabel(l10n.confirmPasswordLabel),
                    const SizedBox(height: 6),
