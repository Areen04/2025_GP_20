...
abstract class AppLocalizations {
  ...
  /// No description provided for @doctorUpdateInfoTitle.
  ///
  /// In en, this message translates to:
  /// **'Update Your Information'**
  String get doctorUpdateInfoTitle;

  /// No description provided for @doctorUpdateDocNumberTenDigits.
  ///
  /// In en, this message translates to:
  /// **'Must be exactly 10 digits.'**
  String get doctorUpdateDocNumberTenDigits;

  /// No description provided for @doctorUpdatePassportRequirement.
  ///
  /// In en, this message translates to:
  /// **'Must contain letters and numbers, at least 5 characters.'**
  String get doctorUpdatePassportRequirement;

  /// No description provided for @doctorUpdateMedicalLicenseRequirement.
  ///
  /// In en, this message translates to:
  /// **'Must be at least 5 letters or numbers.'**
  String get doctorUpdateMedicalLicenseRequirement;

  /// No description provided for @doctorUpdateSelectDocumentTypeFirst.
  ///
  /// In en, this message translates to:
  /// **'Select a document type first.'**
  String get doctorUpdateSelectDocumentTypeFirst;
  ...
  /// No description provided for @doctorRequestRejectedTitle.
  ///
  /// In en, this message translates to:
  /// **'Request Rejected'**
  String get doctorRequestRejectedTitle;

  /// No description provided for @doctorRequestRejectedDefaultMessage.
  ///
  /// In en, this message translates to:
  /// **'Your request was rejected. Please update your information.'**
  String get doctorRequestRejectedDefaultMessage;

  /// No description provided for @doctorRejectionReasonOfficialRecords.
  ///
  /// In en, this message translates to:
  /// **'The provided information does not match the official records.'**
  String get doctorRejectionReasonOfficialRecords;
  ...
  /// No description provided for @vaccinationsSkippedVaccinations.
  ///
  /// In en, this message translates to:
  /// **'Skipped Vaccinations'**
  String get vaccinationsSkippedVaccinations;
  ...
  /// No description provided for @vaccinationsSkipped.
  ///
  /// In en, this message translates to:
  /// **'Skipped'**
  String get vaccinationsSkipped;
