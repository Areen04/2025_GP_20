...
class _DevelopmentalMilestones3yearState
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          centerTitle: true,
          title: Text(
            l10n.ms_3year_developmental_milestones,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // SOCIAL
                    _buildSection(
                      title: l10n.ms_3year_social_emotional,
                      index: 0,
                      milestones: [
                        _MilestoneCard(
                          title: l10n
                              .ms_3year_calms_down_within_10_minutes_after_you_leave_her,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_3year_notices_other_children_and_joins_them_to_play,
                    ...
                    // SPEECH
                    _buildSection(
                      title: l10n.ms_3year_speech_language,
                      index: 1,
                      milestones: [
                        _MilestoneCard(
                          title: l10n
                              .ms_3year_talks_with_you_in_at_least_two_back_and_forth_exchanges,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_3year_asks_who_what_where_or_why_questions,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_3year_says_what_action_is_happening_in_a_picture_or_book,
                        ...
                        _MilestoneCard(
                          title: l10n.ms_3year_says_first_name_when_asked,
                        ...
                        _MilestoneCard(
                          title: l10n
                              .ms_3year_talks_well_enough_for_others_to_understand,
                    ...
                    // COGNITIVE
                    _buildSection(
                      title: l10n.ms_3year_cognitive_development,
                      index: 2,
                      milestones: [
                        _MilestoneCard(
                          title: l10n
                              .ms_3year_draws_a_circle_when_you_show_her_how,
                        ...
                        _MilestoneCard(
                          title: l10n.ms_3year_avoids_touching_hot_objects,
                          videoUrl:
                    ...
                    // MOVEMENT
                    _buildSection(
                      title: l10n.ms_3year_movement_physical_development,
                      index: 3,
                      milestones: [
                        _MilestoneCard(
                          title:
                        ...
                        _MilestoneCard(
                          title: l10n.ms_3year_puts_on_some_clothes_by_herself,
                        ...
                        _MilestoneCard(
                          title: l10n.ms_3year_uses_a_fork,
  ...
  Widget _buildProgressCard(double progress) => Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(l10n.ms_3year_overall_progress,
                style: const TextStyle(
                    fontFamily: 'Inter',
            ...
            Text(
              l10n.ms_3year_only_check_milestones_you_re_confident_your_child_has_achiev,
              style: const TextStyle(
                fontFamily: 'Inter',
            ...
            Text(
              l10n.ms_3year_completedcount_of_totalmilestones_milestones_complete(
